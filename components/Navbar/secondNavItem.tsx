    ...
    <div className='h-full flex-shrink-0'>
      <Link
        ...
        className={
          ...
          (path === route
            ? ' fill-gray-600  text-gray-600 hover:cursor-pointer hover:bg-gray-200 '
      ...
      >
        ...
        {path === route ? (
          <span
            className='absolute bottom-[-.125rem] left-0 right-0 rounded-b-0
                  rounded-t border-t-[.25rem] border-solid border-gray'
          ></span>
        ) : (
          <></>
        )}
